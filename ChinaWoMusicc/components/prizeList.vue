<template>
	<section class="prize-panel-list">
		<div class="prize-title">
			<a class="btn" style="background: url(c/images/join-btn.png);">
				中奖榜单
			</a>
		...
		<div class="data-panel" style="background: url(c/images/bg-zjbd.png);">
			<ul class="data-ul">
				<li v-for="list in prizeList" style="background: url(c/images/libg-zjbd.png);">
