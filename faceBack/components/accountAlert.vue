<template>
	<div class="alert" v-if="show">
      ...
      <label for="exampleInputName2">&nbsp账&nbsp&nbsp&nbsp&nbsp号&nbsp：</label> <input type="text" class="form-control myID" :disabled="mytype==='编辑'" id="exampleInputName2" placeholder="easier" v-model="myForm.name"> 
