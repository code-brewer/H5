	...
	<modal :show.sync="loginShow" :bg="false">
		<div class="components-login">
			<div class="box" style="background: #fffbf1; border-radius: 20px;">
				...
				<a class="confirm-btn" style="background: url('./i/images/login-btn.png') center center no-repeat;" @click="loginFun()"></a>
				<img class="close-img" :src="'i/images/sp-close.png'" @click="loginShow = false">
			</div>
		</div>
	</modal>
</template>
