	...
	<div class="app-view game-page">
		<section class="section-wrap">
			<div class="activity-num-div">
				...
				<div class="activity-num" style="background: url('./i/images/count-bg.png') center center no-repeat;">
					还有<i class="num">{{times1}}</i>次机会
				</div>
				<!-- <a class="gamemark" @click="mark" ></a> -->
			</div>
			<div class="prize-wrap-new" id="lottery">
				<table class="prize-box" border="0" cellspacing="4" cellpadding="0" style="background-image: url('./i/images/prize-box-bg.png');">
					<tr>
			...
			<div class="downdiv">
				<p class="tip4">会员用户可获得5次抽奖机会<span @click="govip()">立即开通</span></p>
			...
			<div class="content" style="text-align: center;">
				<div class="div1" v-if="alertTip.Atip">
					<div v-if="lotteryObj.sid ==''">
						...
						<a class="btn" @click="hideAlertTip()" style="background: url('./i/images/btn-bg.png') center center no-repeat; margin-right:15px;" v-if="alertTip.state==0">继续抽奖</a>
						<a class="btn" @click="addr()" style="margin-top: 0;background: url('./i/images/btn-bg-gray.png') center center no-repeat; margin-left: 15px;">去领奖</a>
					</div>
					<div v-if="lotteryObj.sid !=''">
						<div class="content-title">
							<p>恭喜您</p>
						...
						<!-- <a class="btn" @click="awardRightNow()" style="background: url('./i/images/btn-bg.png') center center no-repeat; margin-right:15px;">马上领奖</a> -->
				...
				<div class="div4" v-if="alertTip.Dtip">
					...
					<div style="padding: 50px 0;">
						...
						<p class="text1" v-if="ispass == 'true'">抽奖机会用光了， 明天再来吧！</p>
