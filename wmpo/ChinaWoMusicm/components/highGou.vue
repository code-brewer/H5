	...
	<modal :show.sync="highgouShow" :bg="false">
		<div class="components-highhou">
			...
			<div class="box" style="background: #fff; border-radius: 20px; border: 10px solid #fbb03b;">
				...
				<a style="background: url('./m/images/close-btn.png') center center no-repeat;" class="confirm-btn" @click="highgouShow = false"></a>
				
				<img class="close-img" :src="'m/images/close.png'" @click="highgouShow = false">
			</div>
		</div>
	</modal>
</template>
