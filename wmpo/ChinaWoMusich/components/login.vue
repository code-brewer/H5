	...
	<modal :show="false" :bg="false">
		<div class="components-login">
			<div class="box" style="background: #131620; border: 2px solid #3bbfe7;">
				...
				<img class="close-img" :src="basePath+'f/images/sp-close.png'" @click="loginShow = false">
			</div>
		</div>
	</modal>
</template>
...
<script>
	...
	export default{
		...
		watch:{
			loginShow(v){
				if(v){
					window.location.href="http://wxtmqc.10155.com/wostar2/redirect/toIndex.do?appid=4730005";
				}else{
