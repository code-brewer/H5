<template>
    <div class="app-view bells-page">
        <section class="section-bell" :style="{'height':height+'px'}">
            <div class="main-bg">
                <img :src="'q/images/ring-bg.jpg'" :style="{'height':height+'px'}">
            </div>
            <div class="logo">
            ...
            <div class="btn-panel" v-if="$root.cookieVip != '0000000000'" style="text-align: center;">
                 <a class="btn" @click="openvip"  style="margin-top: 0;background: url('./q/images/btn-bg.png') center center no-repeat; margin-left: 15px;">开通会员</a>
            </div>
            ...
            <div class="prize-over-view" style="position: relative;">
                <div class="box text-center" style="background-image: url('./q/images/wen.jpg'); background-repeat-y: repeat;">
                   <div style="padding-bottom: 30px;">
                        ...
                        <a class="confirm-btn" @click="sureBuyLing()" style="margin-top: 0;background: url('./q/images/btn-bg.png') center center no-repeat; margin-left: 25%;">确定</a>
                    ...
                    <div class="close-img" @click="showBuyTone = false">   <img :src="'q/images/close.png'" />
                    </div>
                    <img class="bottom" :src="'q/images/wen-bottom1.png'" />
                </div>
            </div>
        </modal>
       <!--订购成功-->
    ...
    font-weight: 700;">订购成功!</p>
                        ...
                        <a class="confirm-btn" @click="showSuccess = false" style="margin-top: 0;background: url('./q/images/btn-bg.png') center center no-repeat; margin-left: 25%;">确定</a>
                    </div>
                    <div class="close-img"  @click="showSuccess = false"><img :src="'q/images/close.png'" /></div>
                </div>
...
<style lang="sass">
   ...
   .prize-over-view{
    ...
    // text-align: center;
        ...
        .more{
            border-bottom: 1px solid #8f1225;
            color: #8f1225;
            font-size: 26px;
            text-align: center;
            width: 56%;
        ...
        data() {
            return {
                ringList:[{
                    song:'中国喜事(Live 版)',
                    singer:'凤凰传奇+SNH48',
                    songAndSinger:'中国喜事（Live 版）-凤凰传奇+SNH48',
                    iconListen:'q/images/open.png',
                    iconListenD:true,
                    iconMusic:'q/images/pause.png',
                    musicSrc:'q/images/m1.mp3',
                    toneId:'9238900020150508182312',
                    vipToneId:'9238900020150819276892'

                },
                {
                    song:'倍儿爽(Live版)',
                    singer:'大张伟',
                    songAndSinger:'倍儿爽（Live版）-大张伟',
                    iconListen:'q/images/open.png',
                    iconListenD:true,
                    iconMusic:'q/images/pause.png',
                    musicSrc:'q/images/m2.mp3',
                    toneId:'9238900020150729205299',
                    vipToneId:'9238900020150825294293'

                },
                {
                    song:'贺新年',
                    singer:'众星',
                    songAndSinger:'贺新年-众星',
                    iconListen:'q/images/open.png',
                    iconListenD:true,
                    iconMusic:'q/images/pause.png',
                    musicSrc:'q/images/m3.mp3',
                     toneId:'9072100020120921356507',
                    vipToneId:'9072100020150820279487'

                },
                {
                    song:'月半小夜曲(Live版)',
                    singer:'李易峰',
                    songAndSinger:'月半小夜曲(Live版) -李易峰',
                    iconListen:'q/images/open.png',
                    iconListenD:true,
                    iconMusic:'q/images/pause.png',
                    musicSrc:'q/images/m4.mp3',
                     toneId:'9772000020170105412011',
                    vipToneId:'9772000020170105412073'

                },
                {
                    song:'祝福(Live版)',
                    singer:'杨钰莹',
                    songAndSinger:'祝福(Live版) -杨钰莹',
                    iconListen:'q/images/open.png',
                    iconListenD:true,
                    iconMusic:'q/images/pause.png',
                    musicSrc:'q/images/m5.mp3',
                     toneId:'9772000020170105412039',
                    vipToneId:'9772000020170105412101'
