	...
	<modal :show.sync="buytoneSuccessShow" :bg="false">
		<div class="components-vipsuccess">
			<div class="box text-center" style="background-image: url('./q/images/wen.jpg'); background-repeat-y: repeat;">
				...
				<a style="background: url('./q/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="buytoneSuccess">确<span style="font-family: none;">&nbsp;</span>认</a>
				<img class="close-img" :src="'q/images/close.png'" @click="buytoneSuccessShow = false">
