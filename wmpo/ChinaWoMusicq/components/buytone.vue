	...
	<modal :show.sync="buytoneShow" :bg="false">
		<div class="components-buytone">
			<div class="box text-center" style="background-image: url('./q/images/wen.jpg'); background-repeat-y: repeat;">
				<img :src="$root.activityBasePath+'/images/light.png'" style="position: absolute; left: 0px;">
				...
				<a style="background: url('./q/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="buyToneNow()">确<span style="font-family: none;">&nbsp;</span>认</a>
				...
				<img class="close-img" :src="'q/images/close.png'" @click="buytoneShow = false">
