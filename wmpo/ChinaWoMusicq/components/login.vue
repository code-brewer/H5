	...
	<modal :show.sync="loginShow" :bg="false">
		<div class="components-login">
			<div class="box" style="background-image: url('./q/images/wen.jpg'); background-repeat-y: repeat;">
				...
				<a class="confirm-btn" style="background: url('./q/images/btn-bg.png') center center no-repeat; margin: 50px auto;" @click="loginFun()">登 录</a>
				<img class="close-img" :src="'q/images/close.png'" @click="loginClose">
