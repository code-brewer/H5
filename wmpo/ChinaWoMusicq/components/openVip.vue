	...
	<modal :show.sync="openvipShow" :bg="false">
		<div class="components-openvip">
			<div class="box text-center" style="background-image: url('./q/images/wen.jpg'); background-repeat-y: repeat;">
				...
				<a style="background: url('./q/images/btn-bg.png') center center no-repeat; " class="confirm-btn" @click="openVipRightNow()">GO</a>
				<img class="close-img" :src="'q/images/close.png'" @click="openvipShow = false">
