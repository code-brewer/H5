<template>
	<modal :show.sync="successShow" :bg="false">
		<div class="components-success">
			<div class="box" style="background-image: url('./q/images/wen.jpg'); background-repeat-y: repeat;padding-bottom: 50px;">
				<p class="title">领取成功</p>
				<!-- <div style="text-align: center; padding: 15px 0;">
					<img :src="'k/images/award-success.png'" style="vertical-align: middle;">
				</div> -->
				<p class="success-panel">{{tip1}}</p>
				<a style="background: url('./q/images/ling-btn.png') center center no-repeat; display: inline-block; vertical-align: middle; width: 228px; background-size: 100%;" class="confirm-btn" @click="ring()">元宵铃音</a>
				<a style="background: url('./q/images/btn-bg.png') center center no-repeat; display: inline-block; vertical-align: middle; width: 228px; background-size: 100%;" class="confirm-btn" @click="success()">更多活动</a>
				<img class="close-img" :src="'q/images/close.png'" @click="successShow = false">
