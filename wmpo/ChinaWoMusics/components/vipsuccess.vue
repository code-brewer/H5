		...
		<div class="components-vipsuccess">
			<div class="box" style="background: #ffed7d; border-radius: 20px; border: 10px solid #fc842a;">
				...
				<div class="">
					...
					<p style="width: 100%" class="success-panel">开通会员成功，你已享有沃音乐会员权益，100M联通流量于三个工作日内到账！</p>
					
				</div>
				<a style="background: url('./s/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="vipsuccessShow = false">确定</a>
				<img class="close-img" :src="'s/images/close.png'" @click="vipsuccessShow = false">
			</div>
		</div>
	</modal>
</template>
...
<script>
	...
	export default{
		...
		data(){
			return{
				tip:"",
				tip1:"开通会员成功，你已享有沃音乐会员权益， 获得联通50M流量，流量72小时内可到账！",
