		...
		<div class="components-vipsure">
			<div class="box" style="background: #ffed7d; border-radius: 20px; border: 10px solid #fc842a;">
				...
				<div style="text-align:center; padding: 20px;">
					<img :src="'u/images/agree.png'">
				</div>
				<p class="sure-text">（未开通炫铃功能的用户将默认为您开通，4G用户免费，除广东、上海、吉林、甘肃以外的2/3G非炫铃用户开通时须额外收取5元炫铃功能费。）</p>
				<a v-if="!nohasclick"style="background: url('./u/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="vipSure()">确认</a>
				<a v-if="nohasclick" style="background: url('./u/images/btn-bg.png') center center no-repeat;" class="confirm-btn">确认</a>
				<img class="close-img" :src="'u/images/close.png'" @click="vipsureShow = false">
