	...
	<modal :show.sync="vipfailShow" :bg="false">
		<div class="components-vipfail">
			<div class="box" style="background: #ffed7d; border-radius: 20px; border: 10px solid #fc842a;">
				...
				<a style="background: url('./u/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="vipfailShow = false">确定</a>
				<img class="close-img" :src="'u/images/close.png'" @click="vipfailShow = false">
			</div>
		</div>
	</modal>
</template>
