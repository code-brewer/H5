	...
	<modal :show.sync="highgouShow" :bg="false">
		<div class="components-highhou">
		 	<div class="box" style="background: #ffed7d; border-radius: 20px; border: 10px solid #fc842a;">
				...
				<a style="background: url('./u/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="highgouShow = false">关闭</a>
				
				<img class="close-img" :src="'u/images/close.png'" @click="highgouShow = false">
			</div>
		</div>
	</modal>
</template>
