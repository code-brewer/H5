		...
		<div class="components-vipsuccess">
			...
			<div class="box" style="background: #fff; border-radius: 20px;">
				...
				<div class="">
					...
					<p class="success-panel">开通会员成功，你已享有流量全免及下载特权， 还有{{this.rom != 1?tip:tip1}}元话费赠送，次月15日前未取消会员，次 月17日前话费即可到账！</p>
				</div>
				<a style="background: url('./k/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="saveMsg()">确<span style="font-family: none;">&nbsp;</span>认</a>
				<img class="close-img" :src="'k/images/sp-close.png'" @click="vipsuccessShow = false">
			</div>
		</div>
	</modal>
</template>
	...
	export default{
        ...
        methods: {
            saveMsg(){
                ...
                sapi.insertBill(this, body, (back) => {
