		...
		<img :src="$root.activityBasePath+'/images/modal-r.png'" class="right">
			<div class="box" style="background: #fff; border-radius: 20px;">
				...
				<div class="login-panel">
					...
					<a style="background: url('./k/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="openVip()">确<span style="font-family: none;">&nbsp;</span>认</a>
				</div>
				...
				<img class="close-img" :src="'k/images/sp-close.png'" @click="openvipShow = false">
			</div>
		</div>
	</modal>
</template>
