	...
	<modal :show.sync="showAddress" :bg="false">
		<div class="components-receive-address">
			...
			<div class="box" style="background: #fff; border-radius: 20px;">
				...
				<a class="confirm-btn" style="background: url('./k/images/btn-bg.png') center center no-repeat;" @click="getPrize()">确<span style="font-family: none;">&nbsp;</span>认</a>
				<img class="close-img" :src="'k/images/sp-close.png'" @click="showAddress = false">
			</div>
		</div>
	</modal>
