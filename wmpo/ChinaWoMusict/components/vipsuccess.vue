		...
		<div class="components-vipsuccess">
			<div class="box" style="background: #ffed7d; border-radius: 20px; border: 10px solid #fc842a;">
				...
				<div class="">
					...
					<p style="width: 100%" class="success-panel">开通会员成功，你已享有沃音乐会员权益，50M联通流量于三个工作日内到账！</p>
					
				</div>
				<a style="background: url('./t/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="vipsuccessShow = false">确定</a>
				<img class="close-img" :src="'t/images/close.png'" @click="vipsuccessShow = false">
			</div>
		</div>
	</modal>
</template>
