		...
		<div class="board-wrap">
			...
			<div class="board">
				<section class="start" @click="start()" v-show="!isStart">
					...
					<div class="play" v-show="startDuration==''" style="background: url(f/images/play.png) center center no-repeat;"></div>
...
<script>
	...
	export default {
		...
		ready() {
			...
			console.log('this.imgPointer'+this.imgPointer);
			this.imgp = this.images[this.imgPointer];
			this.urlp = this.urls[this.imgPointer];

			console.log('img'+this.urlp);
