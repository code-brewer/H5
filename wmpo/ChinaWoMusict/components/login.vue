	...
	<modal :show.sync="loginShow" :bg="false">
		<div class="components-login">
			...
			<div class="box" style="background: #ffed7d; border-radius: 20px; border: 10px solid #fc842a;">
				...
				<a class="confirm-btn" style="background: url('./t/images/btn-bg.png') center center no-repeat;" @click="loginFun()">登录</a>
				<img class="close-img" :src="'t/images/close.png'" @click="loginShow = false">
			</div>
		</div>
	</modal>
</template>
