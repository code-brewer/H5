	...
	<modal :show.sync="openvipShow" :bg="false">
		<div class="components-openvip">
			<div class="box" style="background: #ffed7d; border-radius: 20px; border: 10px solid #fc842a; margin-top: -100px;">
				...
				<a class="confirm-btn" style="background: url('./t/images/btn-bg.png') center center no-repeat;" @click="openVip()">马上开通</a>
				
				<img class="close-img" :src="'t/images/close.png'" @click="openvipShow = false">
			</div>
		</div>
	</modal>
</template>
