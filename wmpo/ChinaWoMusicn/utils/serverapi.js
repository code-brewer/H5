...
// 登录
//mobile:"" //手机号码,必填
putApi('login', 'py/login', '2011');
// 发送登陆短信验证码
putApi('sendLoginCode', 'py/sendLoginCode', '2010');
//2005 查询榜单列表
...
//开通会员
putApi('openMemberByNet', '/py/openMemberByNet', '2014');
// //开通会员验证码
...
//订购炫铃
putApi('buyTone', '/py/buyTone', '2014');
//开通炫铃功能
putApi('qryUserBasInfo','/py/qryUserBasInfo','2014');
//判断是否有炫铃能力
putApi('findUserBasInfo', '/py/findUserBasInfo', '2014'); 
