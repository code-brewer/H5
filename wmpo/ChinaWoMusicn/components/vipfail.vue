		...
		<div class="components-vipfail">
			...
			<div class="box" style="background: #fff; border-radius: 20px;">
				...
				<div style="padding: 50px 0;">
					<p class="text1" style="font-size: 50px; width: 80%; text-align: left;">请重试</p>
					<p class="text1">（如重试后订购失败， 可关注沃音乐微信 <span> womusic999</span>留言， 联系小沃查询异常哦） </p>
					<!-- <p class="text1" v-if="ispass == 'false'">暂无抽奖机会，请先通关。</p> -->
					<img style="vertical-align: middle;" :src="'./n/images/lele.png'" alt="">
				</div>
				<a style="background: url('./n/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="vipfailShow = false">确<span style="font-family: none;">&nbsp;</span>认</a>
				<img class="close-img" :src="'n/images/close.png'" @click="vipfailShow = false">
			</div>
		</div>
	</modal>
</template>
