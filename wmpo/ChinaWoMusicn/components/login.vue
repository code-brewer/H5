	...
	<modal :show.sync="loginShow" :bg="false">
		<div class="components-login">
			...
			<div class="box" style="background: #fff; border-radius: 20px;">
				...
				<a class="confirm-btn" style="background: url('./n/images/btn-bg.png') center center no-repeat;" @click="loginFun()">登 录</a>
				<img class="close-img" :src="'n/images/close.png'" @click="loginShow = false">
			</div>
		</div>
	</modal>
</template>
