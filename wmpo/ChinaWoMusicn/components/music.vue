...
<script>
	export default{
		props: {
			musicBg: {
				type: String,
				default: 'n/images/music.png'
			},
			musicSrc: {
            				type: String,
            				default: 'n/images/music.mp3'
            			},
		...
		ready(){
			...
			that.timeid = setInterval(function(){
				if(that.musicStatus == 'play'){
					...
					if(that.ael.duration == 'Infinity' && that.ael.currentTime>68){
		...
		methods: {
			toggleAudio() {
				var audio = document.querySelector("#audio");
	 			...
	 			if(audio.paused){
	 				this.musicBg = 'n/images/music.png';
	 				...
	 				this.musicBg = 'n/images/ico_nomusic.png';
