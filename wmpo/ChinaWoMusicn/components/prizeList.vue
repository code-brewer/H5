<template>
	<section class="prize-panel-list">
		<div class="prize-title">
			...
			<a class="btn" style="background: url('./n/images/prize-list-title.png')center center no-repeat;background-size: 100% 100%;">
		...
		<div class="data-panel">
			<div style="width: 100%;height: 100%;background:rgba(138,31,40,.6); border
			:3px solid #ffe442;"></div>
			<ul class="data-ul">
