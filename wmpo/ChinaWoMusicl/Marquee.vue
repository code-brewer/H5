	...
	<div class="app-view game-page">
		<section class="section-wrap">
			...
			<div class="prize-wrap-new" id="lottery">
				<img :src="$root.activityBasePath+'/images/bottom-left.png'" alt="" class="bottom">
				<img :src="$root.activityBasePath+'/images/top-right.png'" alt="" class="top">
				<table class="prize-box" border="0" cellspacing="4" cellpadding="0" style="background-image: url('./l/images/prize-box-bg.png');">
					<tr>
			...
			<div class="downdiv">
				<p class="tip4"><span @click="openVipO" style="text-decoration: underline;color:#a72531">开通沃音乐会员</span>中奖概率马上提高<span>200%</span></p>
				<div class="">
		...
		<section class="bg-section" v-if="alertTip.rootTip">
			<div class="content" style="text-align: center;height: 630px;">
			...
			<img :src="$root.activityBasePath+'/images/modal-r.png'" class="right">
				<div class="div1" v-if="alertTip.Atip">
					<div>
						<div class="content-title">
							<p style="color: #ffae00;font-size: 55px; font-weight: 600; line-height: 70px;">恭喜</p>
							<p style="font-size: 38px;">抽中了'<span style="color: #a72531">{{lotteryObj.prizename}}</span>'</p>
							<div style="width: 281px; height: 272px;background: url('./l/images/pic-bg.png') center center no-repeat;background-size: 100% 100%;position: absolute;top: 35%; left: 63%; margin-left: -215px;">
								<img :src="$root.activityBasePath+lotteryObj.url" style="width: 231px;position: absolute;height: 194px;top: 10%;left: 8%;" />
							</div>
						</div>
						<!-- <a class="btn" @click="hideAlertTip()" style="background: url('./l/images/btn-bg.png') center center no-repeat; margin-right:15px;" v-if="alertTip.state==0">继续抽奖</a> -->
						<a class="btn" @click="addr(lotteryObj.sid)" style="margin-top: 135px;background: url('./l/images/btn-bg.png') center center no-repeat;">马上领奖</a>
					</div>
				</div>
				<div class="div2" v-if="alertTip.Btip">
					<div class="content-title2">
						<p style="color: #ffae00;font-size: 55px; font-weight: 600; line-height: 70px;">谢谢参与!</p>
						<div style="width: 281px; height: 272px;background: url('./l/images/pic-bg.png') center center no-repeat;background-size: 100% 100%;position: absolute; top: 22%; left: 63%; margin-left: -215px;">
							<img :src="$root.activityBasePath+'/images/thank.png'" style="width: 244px;position: absolute;height: 244px;top: 4%;left: 6%;" />
						</div>
					</div>
					<a class="btn" @click="buyTicket" style="background: url('./l/images/btn-bg.png') center center no-repeat; margin-top: 50px;padding-left: 5px;">一键购票</a>
				...
				<div class="div4" v-if="alertTip.Dtip">
					...
					<div style="padding: 50px 0;">
						...
						<img style="vertical-align: middle;" :src="'./l/images/lele.png'" alt="">
					</div>
					<a class="btn" @click="hideAlertTip()" style="margin-top: 0;background: url('./l/images/btn-bg.png') center center no-repeat; margin-left: 15px;">确定</a>
				</div>
				<!-- 订购炫铃 -->
				<div class="div1" v-if="alertTip.Ftip">
					<div class="content-title">
						...
						<div style="width: 430px; height: 272px;background: url('./l/images/pic-bg.png') center center no-repeat;background-size: 100% 100%;position: absolute; top: 28%; left: 50%; margin-left: -215px;">
							<img :src="$root.activityBasePath+lotteryObj.url" style="    width: 244px;position: absolute;height: 244px;top: 4%;left: 17%;" />
						</div>
						
					</div>
					<a class="btn" @click="sureBuyLing" style="margin-top: 100px;background: url('./l/images/btn-bg.png') center center no-repeat; margin-left: 15px;">确定</a>
				</div>
				<div class="div1" v-if="alertTip.Gtip">
					...
					<a class="btn" @click="hideAlertTip()" style="margin-top: 80px;background: url('./l/images/btn-bg.png') center center no-repeat; margin-left: 15px;">确定</a>
				</div>
				<div class="btn-close" @click="hideAlertTip()"><img :src="'l/images/sp-close.png'" /></div>
			</div>
		</section>
		<address :show-address.sync="alertTip.showAddress" :gid="lucky.id"></address>
		<img :src="$root.activityBasePath+'/images/marquee-bg.jpg'" class="bg">
        				...
        				<div class="box" style="background: #fff; border: 2px solid #3bbfe7;border-radius:10px">
        					...
        					<div style="padding-bottom: 30px;">
	        					<div class="offers1">
	    							...
	    							<a class="btn" @click="showoffers(1)" style="margin-top: 0;background: url('./l/images/btn-bg.png') center center no-repeat;">查看</a>
	    						</div>
	        					<div class="offers1">
	    							<img :src="$root.activityBasePath+'/images/offers-1.png'" style="display: inline-block; width: 160px;">
	    							<p class="text">满1000元立减100元&nbsp;优惠券</p>
	    							<a class="btn" @click="showoffers(2)" style="margin-top: 0;background: url('./l/images/btn-bg.png') center center no-repeat;">查看</a>
	    						</div>
        					</div>
        					<div class="btn-close" style="position: absolute; top: 10px; right: 10px;"  @click="offers.show = false"><img :src="'l/images/sp-close.png'" /></div>
        				</div>
        			...
        			<div class="prize-over-view" style="position: relative;">
        				...
        				<div class="box" style="background: #fff; border: 2px solid #3bbfe7;border-radius:10px">
        					...
        					<div style="padding-bottom: 30px;">
	        					...
	        					<a class="btn" @click="showofferstTip = false" style="margin-top: 0;background: url('./l/images/btn-bg.png') center center no-repeat; margin-left: 15px;">确定</a>
        					</div>
        					<div class="btn-close" style="position: absolute; top: 10px; right: 10px;"  @click="showofferstTip = false"><img :src="'l/images/sp-close.png'" /></div>
        				</div>
			...
			<div class="prize-over-view" style="position: relative;">
				...
				<div class="box" style="background: #fff; border: 2px solid #3bbfe7;border-radius:10px">
					...
					<div style="padding-bottom: 30px;">
						...
						<a class="btn" @click="showofferstTip1 = false" style="margin-top: 0;background: url('./l/images/btn-bg.png') center center no-repeat; margin-left: 15px;">确定</a>
					</div>
					<div class="btn-close" style="position: absolute; top: 10px; right: 10px;"  @click="showofferstTip1 = false"><img :src="'l/images/sp-close.png'" /></div>
				</div>
            ...
            openVipO(){
                if(!this.$root.islogin){
                    ...
                    if(this.$root.cookieVip == "0000000000"){
                        this.$dispatch('loading', {text: '会员已开通，无需再开通', show: true, duration: 1000});
                    }else{
...
//			},
			...
			buyTicket(){
				...
				location.href="http://10155.com/damai/toPerformanceInfo.jspx?pid=112992";
			},
			//用户抽奖
			userDoLucky() {
				var that = this;
