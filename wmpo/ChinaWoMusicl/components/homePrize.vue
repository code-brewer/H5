<template>
    <modal :show.sync="show" :bg="false">
        <section class="prize-panel myprize" style="background: #fff;border: 8px solid #f7af49; border-radius: 20px;" v-if="!lingshow && !lingsuccessShow && !lingfailShow && !GoMarquee">
        ...
        <!--提示去抽奖页-->
        <section class="bg-section" v-if="GoMarquee">
                ...
                <div class="div1">
                    <div class="content-title">
                        ...
                        <div style="text-align: center; padding: 15px 0;margin-top: 70px;">
                            ...
                            <p style="color:#f7af49;margin-bottom:10px;font-size:40px">您需到抽奖页领取奖品</p>
                            <p style="color:#f7af49;font-size:40px">谢谢配合！</p>
                        </div>
                    </div>
                    <a class="btn" @click="GoMarquee=false" style="margin-top: 10px;background: url('./l/images/btn-bg.png') center center no-repeat; margin-left: 15px;">确定</a>
                </div>
                <div class="btn-close" @click="GoMarquee=false"><img :src="'l/images/sp-close.png'" /></div>
            </div>
        </section>
