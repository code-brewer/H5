	...
	<modal :show.sync="loginShow" :bg="false">
		<div class="components-login">
			...
			<div class="box" style="background: #fff; border-radius: 20px;">
				...
				<a class="confirm-btn" style="background: url('./l/images/btn-bg.png') center center no-repeat;" @click="loginFun()">登 录</a>
				<img class="close-img" :src="'l/images/sp-close.png'" @click="loginShow = false">
			</div>
		</div>
	</modal>
</template>
...
<style lang="sass">
	...
	.components-login{
		width: 100%;
		/*background:url('../images/game-modal-bg.png')no-repeat;*/
		.box{
			position:relative;
			padding: 20px;
			margin: 0 auto;
