<template>
	<modal :show.sync="show" :bg="false">
		 <section class="prize-panel myprize" style="background: #111902; border: 5px solid #98cf2f;">
		 		<div class="title">
		 				我的奖品
		 		</div>
		 		<ul class="data-ul">
		 			<li v-for="list in prizeList">
						 ...
						 <a class="btn" @click="goPrize(list.gid,list.mobile)" :style="!list.mobile?'background:#98cf2f; border-radius: 6px;':'background:#888888; border-radius: 6px;'" >
						 	{{!list.mobile?'去领奖':'已领取'}}
						 </a>
