		...
		<div class="components-login">
			<div class="box" style="background-image: url('./o/images/wen.jpg'); background-repeat-y: repeat; border: 10px solid #f62a32; border-radius: 20px;">
				...
				<div class="login-panel">
					<div class="phone">
						<span>手机号码：</span>
						<input type="text" v-model="login.mobile"  placeholder="" maxlength="11" style="width: 350px;"/>
					</div>
					<div class="code">
						<span>&nbsp;验证码：</span>
						<input type="text" v-model="login.code" maxlength="6"  placeholder="" style="width: 190px;"/>
						<a  @click="getCode()" :class="{graycode:codeing}" >
							{{timeflag}}
						</a>
					</div>
				</div>
				<a class="confirm-btn" style="background: url('./o/images/btn-bg.png') center center no-repeat; margin: 50px auto;" @click="loginFun()">登 录</a>
				<img class="close-img" :src="'o/images/close.png'" @click="loginClose">
