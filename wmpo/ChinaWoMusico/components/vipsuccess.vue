		...
		<div class="components-vipsuccess">
			<div class="box text-center" style="background-image: url('./o/images/wen.jpg'); background-repeat-y: repeat; border: 10px solid #f62a32; border-radius: 20px;">
				...
				<div class="">
					...
					<p class="success-panel">开通会员成功，你已享有沃音乐会员权益，可以使用通关道具和翻牌领奖，丰富奖品等你拿，继续游戏吧~</p>
				</div>
				<a style="background: url('./o/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="vipsuccess">确<span style="font-family: none;">&nbsp;</span>认</a>
