	...
	<modal :show.sync="buytoneSuccessShow" :bg="false">
		<div class="components-vipsuccess">
			<div class="box text-center" style="background-image: url('./o/images/wen.jpg'); background-repeat-y: repeat; border: 10px solid #f62a32; border-radius: 20px;">
				...
				<a style="background: url('./o/images/btn-bg.png') center center no-repeat;" class="confirm-btn" @click="buytoneSuccess">确<span style="font-family: none;">&nbsp;</span>认</a>
				<img class="close-img" :src="'o/images/close.png'" @click="buytoneSuccessShow = false">
