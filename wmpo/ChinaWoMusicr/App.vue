				...
				api.netLoginForH5(that,{},(back)=>{
					if(back.resCode == '0'){
						...
						if(!localStorage.getItem('LoginMobile')){
							localStorage.setItem('LoginMobile',back.repBody.mobile);
						}
