export default {
     ...
     */
    isWeibo(){var ua = window.navigator.userAgent.toLowerCase();if(ua.match(/weibo/i) == 'weibo'){return true;}else{return false;}},

    isZhifubao(){var ua = window.navigator.userAgent.toLowerCase();if(ua.match(/ali/i) == 'ali'){return true;}else{return false;}},
