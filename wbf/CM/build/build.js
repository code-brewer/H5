...
/******/ 	__webpack_require__.p = "activity/SliderMoney/build/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Rule = __webpack_require__(33);
	...
	var _Award = __webpack_require__(46);

	var _Award2 = _interopRequireDefault(_Award);

	var _Awardret = __webpack_require__(51);

	var _Awardret2 = _interopRequireDefault(_Awardret);

	var _Prizerule = __webpack_require__(56);

	var _Prizerule2 = _interopRequireDefault(_Prizerule);

	var _Attention = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] wbf\\CM\\src\\App.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		ready: function ready() {
			...
			this.$on('loading', function (loading) {
				if (!loading.name) {
					loading.name = 'tip';
				}
				if (!loading.icon) {
			...
			this.$on('cancelloading', function (name) {
				for (var i = 0; i <= that.loadingdata.loadings.length - 1; i++) {
					var item = that.loadingdata.loadings[i];
			...
			this.$on('login', function (parameter) {
				alert("login.jsp");
			});

			this.$on('handle_server_error', function (parameter) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\components\\Loading.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\Home.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-47b8a4d8&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Home.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-47b8a4d8&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Home.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.content > .bw[_v-47b8a4d8] {\n\tposition: absolute;\n\tbottom: 220px;\n\tleft: 88px;\n\tright: 88px;\n\ttext-align: center;\n\ta {\n\t\tdisplay: inline-block;\n\t\t\n\t}\n}\n.content > a.link[_v-47b8a4d8] {\n\tposition: absolute;\n\tbottom: 90px;\n\twidth: 200px;\n\ttext-align: center;\n\tfont-size: 34px;\n\tcolor: #fff;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _serverapi = __webpack_require__(31);
	...
	exports.default = {
	  ready: function ready() {
	    // this.$dispatch('loadingclean');
	    //this.$dispatch('title', '数钱数到手抽筋!');
	    var aid = _url2.default.getArgsFromUrl("aid");
	    console.log("aid---" + aid + "-");
	    this.$dispatch('loading', { name: 'home_init', icon: true, text: '加载中...', show: true, duration: 1 * 1000 });
	    this.loadingCount++;
	...
	// 		<div class="content">
	// 			<div class="bw">
	// 				<a   @click="startclick" class="">
	// 					<img :src="$root.basePath+'src/img/startbtn.png'" alt="" />
	// 				</a>
	// 			</div>
	//
	//
	// 			<a  v-link="{path: '/rule'}" class="link" style="left: 80px;  bottom: 120px;"><img :src="$root.basePath+'src/img/rulebtn.png'"></a>
	// 			<a  v-link="{path: '/ranking'}" class="link" style="right: 80px; bottom: 120px;"><img :src="$root.basePath+'src/img/home-rankbtn.png'"></a>
	// 		</div>
	// 		<img :src="$root.basePath+'src/img/home-bg.jpg'"  class="bg" />
	// 		<img :src="$root.basePath+'src/img/logo.png'" class="logo" />
	// 		<img @click="showShare()" :src="$root.basePath+'src/img/shareicon.png'" class="share" />
	// 		<div v-if="sharetip" @click="hideShare()" class="sharebg"></div>
	// 		<img v-if="sharetip" @click="hideShare()" :src="$root.basePath+'src/img/sharetip.png'" class="sharetip" />
	//
	// 	</div>
	// </template>
	//
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    prizeScoreRankCursuser: function prizeScoreRankCursuser(context, body, fun) {
	        context.$http.post(basePath + 'money/getUserPrizeInfo', getCreds('6008', body), function (back) {
	            if (fun) fun(back);
	        });
	    },

	    // 积分
	    saveUserScore: function saveUserScore(context, body, fun) {
	        context.$http.post(basePath + 'money/saveUserScore', getCreds('7004', body), function (back) {
	            if (fun) fun(back);
	        });
	    },
	    ...
	    //校验用户是否关注公众号
	    isFollow: function isFollow(context, body, fun) {
	        context.$http.post(basePath + 'stat/isFollow', getCreds('6022', body), function (back) {
	            if (fun) fun(back);
	        });
	    }
	};
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"app-view\" _v-47b8a4d8=\"\">\n\t<div class=\"content\" _v-47b8a4d8=\"\">\n\t\t<div class=\"bw\" _v-47b8a4d8=\"\">\n\t\t\t<a @click=\"startclick\" class=\"\" _v-47b8a4d8=\"\">\n\t\t\t\t<img :src=\"$root.basePath+'src/img/startbtn.png'\" alt=\"\" _v-47b8a4d8=\"\">\n\t\t\t</a>\n\t\t</div>\n\t\t\n\t\t\n\t\t<a v-link=\"{path: '/rule'}\" class=\"link\" style=\"left: 80px;  bottom: 120px;\" _v-47b8a4d8=\"\"><img :src=\"$root.basePath+'src/img/rulebtn.png'\" _v-47b8a4d8=\"\"></a>\n\t\t<a v-link=\"{path: '/ranking'}\" class=\"link\" style=\"right: 80px; bottom: 120px;\" _v-47b8a4d8=\"\"><img :src=\"$root.basePath+'src/img/home-rankbtn.png'\" _v-47b8a4d8=\"\"></a>\n\t</div>\n\t<img :src=\"$root.basePath+'src/img/home-bg.jpg'\" class=\"bg\" _v-47b8a4d8=\"\">\n\t<img :src=\"$root.basePath+'src/img/logo.png'\" class=\"logo\" _v-47b8a4d8=\"\">\n\t<img @click=\"showShare()\" :src=\"$root.basePath+'src/img/shareicon.png'\" class=\"share\" _v-47b8a4d8=\"\">\n\t<div v-if=\"sharetip\" @click=\"hideShare()\" class=\"sharebg\" _v-47b8a4d8=\"\"></div>\n\t<img v-if=\"sharetip\" @click=\"hideShare()\" :src=\"$root.basePath+'src/img/sharetip.png'\" class=\"sharetip\" _v-47b8a4d8=\"\">\n\t\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\Rule.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\Game.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-097f8b2a&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Game.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-097f8b2a&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Game.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nhtml[_v-097f8b2a],body[_v-097f8b2a],canvas[_v-097f8b2a] {\n\tmargin: 0px;\n\tpadding: 0px;\n\tborder:none;\n\ttext-align: center;\n\tbackground-color: black;\n}\ncanvas[_v-097f8b2a] {\n\tbackground-color: white;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		ready: function ready() {
			...
			if (gameVue.activity == '') {
				location.href = basePath + "login.jsp?aid=" + aid;
			}
			...
			var exttime = 0;
			if (isshare == "true") {
				exttime = gameVue.activityInfo.timeext;
			}

			//--------------app-------------------

			var TIME_LIMIT = parseInt(gameVue.activityInfo.time) + parseInt(exttime);
			var QIPA_DEBUG = !1;
			...
			(function (a, d) {
				function b() {
					...
					if (SCREEN_SHOW_ALL) k / b > W / H ? k = W * b / H : b = H * k / W, c.style.marginTop = 0;else {
						var d = W * b / H;
			...
			var qp_b = TIME_LIMIT,
			    ...
			    qp_o = 0;
			function qp_p() {
				if (localStorage.getItem('isshare') == "true") {
					exttime = gameVue.activityInfo.timeext;
				}
				TIME_LIMIT = parseInt(gameVue.activityInfo.time) + parseInt(exttime);
				qp_b = TIME_LIMIT;
			...
			function Qp_A() {
				...
				this.m = [];
				for (var a = 0; 3 >= a; a++) {
					this.m[a] = new createjs.Bitmap(qipaStage.queue.getResult("m0")), this.m[a].regX = this.m[a].getBounds().width / 2, this.m[a].regY = this.m[a].getBounds().height / 2, this.m[a].y = qp_g, this.m[a].visible = !1, this.addChild(this.m[a]);
				}for (a = 0; a <= qp_e; a++) {
					this.m[a].image = qipaStage.queue.getResult("m0");
				}for (a = 0; a < qp_c.length; a++) {
					for (var b = 0; b < qp_c[a].length; b++) {
						qp_c[a][b].image = qipaStage.queue.getResult("d0");
					}
				}
			}
			...
			function qp_u() {
				...
				if (0 == qipaApp.score) pass_text = title;else {
					var a = parseInt(Math.sqrt(1E4 * qipaApp.score / 17E3));
					99 < a && (a = "99.9");
					pass_text = '我数了' + S_T + qipaApp.score + '，比' + a + '%的人有钱！我是' + (5E3 > qipaApp.score ? '屌丝' : 1E4 > qipaApp.score ? '贫农' : 15E3 > qipaApp.score ? '富农' : 2E4 > qipaApp.score ? '土豪' : 25E3 > qipaApp.score ? '煤老板' : '资本家') + "...";
		...
		methods: {
			...
			saveUserScore: function saveUserScore(score) {
				var that = this;
				var body = { score: score, scoreorg: 0 };
				that.$dispatch('loading', { name: 'game_saveUserScore', text: '加载中...', icon: true, show: true, duration: 20 * 1000 });
				_serverapi2.default.saveUserScore(that, body, function (back) {
					that.$dispatch('cancelloading', 'game_saveUserScore');
					if (back.resCode == "0") {
						var dd = back.repBody;
			...
			isFollow: function isFollow() {
				var that = this;
				var body = {};
				_serverapi2.default.isFollow(that, body, function (back) {
					if (back.resCode == '0') {

						if (back.repBody.isFollow) {

							_index.router.go({ name: 'ranking' });
						} else {

							_index.router.go({ name: 'attention' });
						}
					} else {
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n<div class=\"app-view\" _v-097f8b2a=\"\">\n\n\t<div class=\"content\" _v-097f8b2a=\"\">\n\t\t<canvas id=\"stage\" _v-097f8b2a=\"\">\n\t\t\t您的浏览器不支持html5, 请换用支持html5的浏览器。\n\t\t</canvas>\n\t\t<!-- <div class=\"gameover\">\n\t\t\t<div>\n\t\t\t\t\n\t\t\t</div>\n\t\t\t\n\t\t</div> -->\n\t</div>\n\t<!-- <img :src=\"activityInfo.backgrounds.home\"  class=\"bg\">\n\t<img :src=\"activityInfo.logo\" class=\"logo\"> -->\n\t<div v-if=\"sharetip\" @click=\"hideShare()\" class=\"sharebg\" _v-097f8b2a=\"\"></div>\n\t<img v-if=\"sharetip\" @click=\"hideShare()\" :src=\"$root.basePath+'src/img/sharetip.png'\" class=\"sharetip\" _v-097f8b2a=\"\">\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\Ranking.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-398c9166&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Ranking.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-398c9166&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Ranking.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"app-view ranking-page\" _v-398c9166=\"\">\n\t<div class=\"content padding\" _v-398c9166=\"\">\n\t\t<div class=\"rankingdbg\" _v-398c9166=\"\">\n\t\t\t<div class=\"sorthead\" _v-398c9166=\"\">\n\t\t\t\t<p class=\"pfirst\" _v-398c9166=\"\">我的最高积分:<span _v-398c9166=\"\">{{PrizeInfo.score}}</span> &nbsp;&nbsp;第<span _v-398c9166=\"\">{{PrizeInfo.rn}}</span>名</p>\n\t\t\t</div>\n\n\t\t\t<div class=\"tab-head\" _v-398c9166=\"\">\n\t\t\t\t<ul _v-398c9166=\"\">\n\t\t\t\t\t<li v-for=\"item in dates\" @click=\"changeDate($index)\" _v-398c9166=\"\">\n\t\t\t\t\t\t<p :class=\"item.classs\" name=\"datesitem\" _v-398c9166=\"\">{{item.name}}</p>\n\t\t\t\t\t</li>\n\t\t\t\t</ul>\n\t\t\t</div>\n\t\t\t<div class=\"sorts\" _v-398c9166=\"\">\n\t\t\t\t<div class=\"sortitem\" v-for=\"list in sortsList\" _v-398c9166=\"\">\n\t\t\t\t\t<img class=\"sorticon\" :src=\"list.head_img\" alt=\"\" _v-398c9166=\"\">\n\t\t\t\t\t<div class=\"sortnick\" _v-398c9166=\"\">\n\t\t\t\t\t\t<p _v-398c9166=\"\">{{list.nick==null?'神秘人':list.nick}}</p>\n\t\t\t\t\t\t<p _v-398c9166=\"\">{{list.score}}分</p>\n\t\t\t\t\t</div>\n\t\t\t\t\t<p class=\"sortrank\" _v-398c9166=\"\">第{{list.rn}}名</p>\n\t\t\t\t</div>\n\t\t\t\t<!-- <p>神秘人的总积分为124个，排名为第1名</p> -->\n\t\t\t</div>\n\t\t\t<div class=\"award\" _v-398c9166=\"\">\n\t\t\t\t<a v-link=\"{path: '/award'}\" v-if=\"activeFlag\" _v-398c9166=\"\">\n\t\t\t\t\t<img :src=\"$root.basePath+'activity/SliderMoney/src/img/awardbtn.png'\" _v-398c9166=\"\">\n\t\t\t\t</a>\n\t\t\t\t<a v-link=\"{path: '/awardret'}\" v-if=\"querysid\" class=\"mybtn buttonbg\" _v-398c9166=\"\">查看券码</a>\n\t\t\t\n\t\t\t</div>\n\t\t\t\n\t\t\t\t\n\t\t\t<p class=\"awardtip\" _v-398c9166=\"\">{{tiptext}}</p>\n\t\t\t<a class=\"awardtip\" v-link=\"{path: '/rule'}\" _v-398c9166=\"\">游戏攻略</a>\n\t\t</div>\n\t\t<div class=\"ranking-title\" _v-398c9166=\"\">排名详情</div>\n\t\t\n\t</div>\n\t<img :src=\"activityInfo.backgrounds.other\" class=\"bg\" _v-398c9166=\"\">\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\Award.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7ec2cdb4&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Award.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7ec2cdb4&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Award.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.mypfirst[_v-7ec2cdb4]{\n\tmargin-top: 90px;\n}\n.prize[_v-7ec2cdb4] {\n\twidth: 640px;\n    margin: auto;\n    color: #ff0000;\n    font-size: 35px;\n    height: 185px;\n    text-align: center;\n    /* line-height: 185px; */\n    padding: 0 40px;\n    margin-top: 10px;\n    vertical-align: middle;\n    display: table-cell;\n}\n.mytip[_v-7ec2cdb4]{\n\tfont-size: 26px;\n\tcolor: #ff0000;\n    font-weight: bold;\n    margin: 0;\n    padding: 0 80px 0 80px;\n}\n.inputphone[_v-7ec2cdb4]{\n\twidth: 378px;\n    height: 100px;\n    border: none;\n    padding-left: 15px;\n    padding-right: 15px;\n    text-align: center;\n    font-size: 50px;\n}\n.inputcheckcode[_v-7ec2cdb4]{\n\twidth: 125px;\n    height: 56px;\n    border: none;\n    vertical-align: top;\n    padding-left: 10px;\n    padding-right: 10px;\n    text-align: center;\n    font-size: 25px;\n}\n.sorthead[_v-7ec2cdb4]{\n\tfont-size: 30px !important;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"app-view ranking-page award-page\" _v-7ec2cdb4=\"\">\n\t<div class=\"content padding\" _v-7ec2cdb4=\"\">\n\t\t<div class=\"rankingdbg\" _v-7ec2cdb4=\"\">\n\t\t\t<div class=\"sorthead\" _v-7ec2cdb4=\"\">\n\t\t\t\t<p class=\"pfirst mypfirst\" _v-7ec2cdb4=\"\">我的最高积分:<span _v-7ec2cdb4=\"\">{{PrizeInfo.score}}</span> &nbsp;&nbsp;第<span _v-7ec2cdb4=\"\">{{PrizeInfo.rn}}</span>名，获得了</p>\n\t\t\t</div>\n\t\t\t<p class=\"prize\" _v-7ec2cdb4=\"\">{{PrizeInfo.pname}}</p>\n\t\t\t<input type=\"text\" class=\"inputphone inputbg\" autocomplete=\"off\" value=\"输入手机号\" @focus=\"inputmobiletip()\" onblur=\"if(this.value == '') {this.value = '输入手机号';}\" v-model=\"mobile\" _v-7ec2cdb4=\"\">\n\t\t\t<div class=\"codeline\" _v-7ec2cdb4=\"\">\n\t\t\t\t<img :src=\"zcodeurl\" @click=\"refreshzcode()\" alt=\"\" _v-7ec2cdb4=\"\">\n\t\t\t\t<input type=\"text\" class=\"inputcheckcode inputbg\" autocomplete=\"off\" value=\"输入验证码\" @focus=\"inputcodetip()\" onblur=\"if(this.value == '') {this.value = '输入验证码';}\" v-model=\"zcode\" _v-7ec2cdb4=\"\">\n\t\t\t</div>\n\n\t\t\t<p class=\"awardtip\" _v-7ec2cdb4=\"\">{{tiptext}}</p>\n\t\t\t<!-- <div>\n\t\t\t\t<img :src=\"$root.basePath+'randomValidate/obtainValidateCode'\" alt=\"\">\n\t\t\t\t<input type=\"text\" class=\"inputcheckcode inputbg\" />\n\t\t\t</div> -->\n\t\t\t<div class=\"award\" _v-7ec2cdb4=\"\">\n\t\t\t\t<a @click=\"award()\" class=\"button\" _v-7ec2cdb4=\"\">\n\t\t\t\t\t<img :src=\"$root.basePath+'activity/SliderMoney/src/img/awardbtn2.png'\" _v-7ec2cdb4=\"\">\n\t\t\t\t</a>\n\t\t\t\t\n\t\t\t</div>\n\t\t\t\n\t\t\t\n\t\t</div>\n\t\t<div class=\"ranking-title\" _v-7ec2cdb4=\"\">领奖</div>\n\t\t\n\t</div>\n\t<img :src=\"activityInfo.backgrounds.other\" class=\"bg\" _v-7ec2cdb4=\"\">\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\Awardret.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3f7ff21d&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Awardret.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3f7ff21d&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Awardret.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.mybtn[_v-3f7ff21d]{\n\t/*background: url('./img/btn.png');*/\n    background-size: 100% 100%;\n    width: 250px;\n    height: 115px;\n    display: inline-block;\n    line-height: 115px;\n    font-size: 34px;\n    color: #ff560b;\n    font-weight: bold;\n    text-decoration: none;\n}\n.mypfirst[_v-3f7ff21d]{\n\tmargin-top: 80px;\n\tfont-size: 50px;\n}\n.prizecode[_v-3f7ff21d] {\n\tcolor: #ff0000;\n\tfont-size: 34px;\n\tmargin: 0;\n}\n.zcode[_v-3f7ff21d]{\n\tdisplay: inline-block;\n\tpadding:15px;\n\n}\n.mytip[_v-3f7ff21d]{\n\tfont-size: 28px;\n\tcolor: #ff0000;\n    font-weight: bold;\n    margin: 0;\n    padding: 0 120px 0 120px;\n}\n.inputphone[_v-3f7ff21d]{\n\twidth: 378px;\n    height: 100px;\n    border: none;\n}\n.inputcheckcode[_v-3f7ff21d]{\n\twidth: 125px;\n    height: 56px;\n    border: none;\n    vertical-align: top;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"app-view ranking-page\" _v-3f7ff21d=\"\">\n\t<div class=\"content padding\" _v-3f7ff21d=\"\">\n\t\t<div class=\"rankingdbg\" _v-3f7ff21d=\"\">\n\t\t\t<div class=\"sorthead\" _v-3f7ff21d=\"\">\n\t\t\t\t<p class=\"pfirst mypfirst\" _v-3f7ff21d=\"\">恭喜您领奖成功！</p>\n\t\t\t</div>\n\t\t\t<p class=\"prizecode\" _v-3f7ff21d=\"\">您的兑奖码为:</p>\n\t\t\t<p class=\"prizecode\" _v-3f7ff21d=\"\">{{querysidinfo.sid}}</p>\n\n\t\t\t<img @click=\"isIosWx\" class=\"zcode\" :src=\"$root.basePath+'activity/SliderMoney/src/img/wechat.jpg'\" alt=\"\" _v-3f7ff21d=\"\">\n\t\t\t\n\t\t\t<p class=\"mytip\" _v-3f7ff21d=\"\">请关注河南114微信公众号了解更多精彩活动！</p>\n\t\t\t<p class=\"mytip\" _v-3f7ff21d=\"\">安卓请长按，IOS请点击</p>\n\t\t\t<a v-link=\"{path: '/home'}\" class=\"mybtn buttonbg\" _v-3f7ff21d=\"\">返回首页</a>\n\t\t\t<a v-link=\"{path: '/prizerule'}\" class=\"mybtn buttonbg\" _v-3f7ff21d=\"\">奖品使用方法</a>\n\t\t\t\n\t\t</div>\n\t\t<div class=\"ranking-title\" _v-3f7ff21d=\"\">领奖成功</div>\n\t\t\n\t</div>\n\t<img :src=\"activityInfo.backgrounds.other\" class=\"bg\" _v-3f7ff21d=\"\">\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\Prizerule.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports) {
	...
	// 				<img :src="$root.basePath+'activity/SliderMoney/src/img/prize-rule-wx.png'" />
	//
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] wbf\\CM\\src\\Attention.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports) {
	...
	// <template>
	// 	<div class="app-view rule-page attention-page">
	// 		<div class="content padding">
	// 			<h2>请关注后查看排名</h2>
	// 			<p style="margin-top: 20px;">安卓请长按，IOS请点击</p>
	// 			<div class="img">
	// 				<img @click="isIosWx" class="zcode" :src="$root.basePath+'activity/SliderMoney/src/img/wechat.jpg'" alt="">
	// 			</div>
	// 		</div>
