...
public class HttpKit {
    ...
    public static void main(String[] args) {
        ...
        try {
        	if (1==10){
        	String url="http://192.168.0.79:9802/callhttp/call/bind";
        	String openid = "ohmn3t3lCFHJvV44_cZlZi9uog-I";
    		...
    		JSONObject req = JSONObject.parseObject("{reqtime:'" + reqtime + "',openid:'" + openid + "',mobile:'" + mobile
    				+ "',signature:'" + signature + "'}");
            String rsp= post(url,req.toJSONString());
			System.out.println(rsp);
        	}
        	
        	
        	if (1==1){
            	String url="http://61.158.237.34/WoLife-MobileInterface/mobile/main/getarea.do";
            	 url="http://61.158.237.34/WoLife-MobileInterface/mobile/query/getShopTypeList.do";
                String rsp= get(url,null);
    			System.out.println(rsp);
            	}
