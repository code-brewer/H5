...
public class JFreeChartUtil {
	 ...
	 * @author qiufh
	 */
	public static JFreeChart createBarChart3D(String chartTitle, String categoryAxisLabel, String valueAxisLabel, CategoryDataset dataSet, PlotOrientation orientation,
	 ...
	 * @author qiufh
	 */
	public static JFreeChart createBarChart(String chartTitle, String categoryAxisLabel, String valueAxisLabel, CategoryDataset dataSet, PlotOrientation orientation,
			boolean legend, boolean tooltips, boolean urls) {
		//创建主题样式 
		StandardChartTheme standardChartTheme = new StandardChartTheme("CN");//设置标题字体
		standardChartTheme.setExtraLargeFont(new Font("宋书", Font.BOLD, 20));//设置图例的字体
	 ...
	 * @author qiufh
	 */
	public static JFreeChart createPieChart3D(String chartTitle, DefaultPieDataset dataSet, boolean legend, boolean tooltips, boolean urls) {
	 ...
	 * @author qiufh
	 */
	public static JFreeChart createPieChart(String chartTitle, DefaultPieDataset dataSet, boolean legend, boolean tooltips, boolean urls) {
	 ...
	 * @author qiufh
	 */
	public static JFreeChart createLineChart3D(String chartTitle, String categoryAxisLabel, String valueAxisLabel, CategoryDataset dataSet, PlotOrientation orientation,
			boolean legend, boolean tooltips, boolean urls) {
	 ...
	 * @author qiufh
	 */
	public static JFreeChart createLineChart(String chartTitle, String categoryAxisLabel, String valueAxisLabel, CategoryDataset dataSet, PlotOrientation orientation,
			boolean legend, boolean tooltips, boolean urls) {
