...
import cn.comm.bean.RequestMsg;
...
public class ParamParseUtil {
	...
	public static RequestMsg parseReqMsgWithjson(JSONObject jsonObj) {
		...
		reqMsg.setReqTime(jsonObj.getString("reqtime"));
		reqMsg.setProNo(jsonObj.getString("proNo"));
		reqMsg.setMobile(jsonObj.getString("mobile"));
		reqMsg.setOpenid(jsonObj.getString("openid"));
		reqMsg.setSignature(jsonObj.getString("signature"));
		reqMsg.setReqBody(jsonObj);
