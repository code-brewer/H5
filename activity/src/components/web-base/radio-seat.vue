<template>
	<label class="radio-ripple" :class="{'is-disabled': IS_DISABLED, 'is-checked': IS_CHECKED, 'is-focused': IS_FOCUSED}" @mouseup="boundElementMouseUp" v-el:wrap>
		<input type="radio" class="radio-input" :checked="checked" v-model="model" :disabled="disabled" @focus="boundInputOnFocus" @blur="boundInputOnBlur" :name="name" :value="value" v-el:input>
