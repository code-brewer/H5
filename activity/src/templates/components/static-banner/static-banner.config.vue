<template>
	<div class="wap-static-banner" v-el:banner :style="{'background-image':(activityConfig.banner.imgUrl?'url('+activityConfig.banner.imgUrl+')':1),'height':activityConfig.banner.imgH}">
		<edit-btn></edit-btn>
