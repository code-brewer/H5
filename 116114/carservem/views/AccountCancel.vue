<template>
    <h1 class="manage">销户查询</h1>
    <div class="oneAccount" style="margin: 35px 50px;background-color:#fff;border:1px solid #ccc;">销户短信内容为：<span style="color:#ff0000;">您已成功注销沃爱车违章短信提醒功能。</span></div>
    <div class="accountBody">
        <div class="oneAccount">单个销户</div>
        <table class="AcountTable">
            <tbody>
                <tr>
                    <td class="leftTd" style="position:relative;">
                        <span>填写手机号码</span>
                        <input type="text" style="border:1px solid #ccc;height:80%;width:200px;" v-model="myPhone"></input>
                ...
                <tr>
                    <td class="leftTd">
                        <div style="display:inline-block;position:relative;">
                            <input type="checkbox" class="" style="position: absolute;left: 165px;top: 8px;width:22px;" v-model="onedel" id="nosend"></input>
                            <label for="nosend" style="position:relative;display:inline-block;">下发短信告诉用户销户? </label>
                        </div>
                    </td>
                </tr>
            </tbody>
    ...
    <div style="text-align:center;margin-bottom:30px;">
        <a class="sub" @click="cancle()">提交</a>
    </div>
    <div class="accountBody">
        <div class="oneAccount">批量销户</div>
        <table class="AcountTable">
            <tbody>
                <tr>
                    <td class="leftTd">导入文件
                        <input class="uploadbox" placeholder="（可传xlsx、xls格式文件）" v-model="addPrizeFileName" style="width:200px;"></input>
                        <file-upload name="delaccount" action="file/import" :auto="true" class="upload-btn" style="display:inline-block;"></file-upload> <a @click="TableInstanceDel" style="color:#587ebf;cursor:pointer;">表格事例</a>
                    </td>
                </tr>
                <tr>
                    <td class="leftTd">
    ...
    <div style="text-align: center;margin-bottom:30px;">
        <a class="sub" @click='cancleAll'>提交</a>
    </div>
...
export default {
    ...
    methods: {
        ...
        cancleAll() {
            ...
            this.isLoad = true;
            api.cancleAll(this, this.all, (back) => {
                if (back.resCode == "0") {
                    this.isLoad = false;
