		...
		computed: {
			...
			list() {
				var options = {
					success1: {
						title: '中奖提示',
						text: '运气超棒!<br/>恭喜获得<span class="orange">' + this.gift.name + '</span>一份，<br/>请在<span class="orange">'+ (new Date(+(this.ctime+'000')).add({day: 10}).format('MM月dd日')) + '前</span>进入<span class="orange">【我的】</span>填写联系信息，逾期不填将视为弃奖哦！',
						p: 'PS：好运气要多分享才能持续哦，快快让朋友们羡慕下吧！'
					},
					success2: {
						title: '中奖提示',
						text: '赞！恭喜获得<span class="orange">' + this.gift.name + '</span>一张，奖品将在<span class="orange">15个工作日</span>内发放至<span class="orange">【我的卡券】</span>，请及时领取。',
						p: 'PS：好运气要多分享才能持续哦，快快让朋友们羡慕下吧！'
					},
					error: {
						title: '提示',
