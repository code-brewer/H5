<template>
	<div class="app-view home-page">
		<section class="section-home">
	         <div class="main-bg">	
	         	<img :src="'b/images/main-bg.jpg'">
	         </div>
	         <div class="logo">
	         	<img :src="'b/images/logo.png'">
	         </div>
	         <!-- <div class="music-panel">	
	         	<img :src="musicBg" @click="stopMusic">
	         </div> -->
	         <div class="btn-panel">
	         	<img :src="'b/images/btn.png'" @click="start()">
	         </div>
   		...
   		<section class="model" v-show="showMsg">
   			<div class="panel">
   				<div class="msg">
   					<div>	
   						<p style="background: url(b/images/msg-border.png);">请在60秒内， 控制力度条停在白色区域时挥杆进球。 开始GOLF王征途吧~</p>
   						<a class="btn"  @click="showTimeOutPanel()" style="background: url(b/images/btn-1.png)">
							START
		   				</a>
   					</div>
   				</div>
   		...
   		<section class="model" v-show="showTimeOut">
			<div class="timeout-panel">
			 		<div class="msg" style="background: url(b/images/timeout-bg.png);">
						{{timeFlag}}
					</div>
			</div>			
 	   </section>
