<template>
    <div class="Rate" v-if="length > 0">
        ...
        <template v-for="n in length">
            <!-- <a href="javascript:;" :class="{'Rate__star': true, 'hover': n <= over, 'filled': n <= rate}" @mouseover="onOver(n)" @click="setRate(n)" @keyup="onOver(n)" @keyup.enter="setRate(n)"> -->
            <a href="javascript:;" :class="{'Rate__star': true, 'hover': n <= over, 'filled': n <= rate}" @mouseover="onOver(n)" @click="setRate(n)" @keyup="onOver(n)"">
