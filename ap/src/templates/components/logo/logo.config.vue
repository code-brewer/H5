			...
			<div class="modal-panel"
				...
				<div class="content">
					<div class="spane">
						...
						<div class="nr">
							<p class="check-box">
								<radio name="logoCheck"
								       :model.sync="activityConfig.logo.isText"
								       :checked="radioCheck"
								       value="true">文字</radio>
								<radio name="logoCheck"
								       :model.sync="activityConfig.logo.isText"
								       ...
								       value="false">图片</radio>
							</p>
							<div class="text-panel"
							     v-show="activityConfig.logo.isText=='true'">
								<p class="col">
									<span>文字：</span>
									<input type="text"
									       class="form-control"
									       v-model="activityConfig.logo.text.value"
									       style="margin-left: 24px; display: inline-block;width: 200px;" />
								</p>
								<p class="col">
									<span>颜色：</span>
									<i :style="{'background-color':activityConfig.logo.text.color}"
								...
								<p class="col">
									...
									<slider max="3"
									        ...
									        s
									        style="width: 300px;"
									        :value.sync="logoSize"></slider>
								</p>
							</div>
							<div class="img-panel"
							     v-show="activityConfig.logo.isText=='false'">
								<upload :config="uploadConfig"
								        :img-url.sync="activityConfig.logo.imgUrl"
								        :is-center="false">
								</upload>
							</div>
						</div>
