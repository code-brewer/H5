<template>
	<div class="app-view view-home" :style="{backgroundImage: (activityConfig.bg.imgUrl!=''?'url('+activityConfig.bg.imgUrl+')':1), 'background-size':'100% 100%'}">
		...
		<modal :show.sync="showForm" size="md">
			<div class="modal-panel">
				...
				<upload-image :img-url.sync="activityConfig.bg.imgUrl" 
					:config="uploadConfig"
					:default-image="'./templates/static/img/bg.1480320.jpg'"
				>
				</upload-image>
			</div>
		</modal>
	...
	export default {
		data() {
				...
				return {
					...
					uploadConfig: {
						...
						onSelect: function(selectFiles, allFiles) {
							console.info('info---selected:', selectFiles)
						}
					}
				}
			},
			components: {
				...
				'static-banner': require('../../../components/static-banner-new/static-banner.config'),
				'remaining-number-of-prizes': require('../../../components/remaining-number-of-prizes/remaining-number-of-prizes.config'),
				'start-button': require('../../../components/button-new/start-button.config'),
				'rule-link': require('../../../components/rule-link/rule-link-new.config.vue'),
