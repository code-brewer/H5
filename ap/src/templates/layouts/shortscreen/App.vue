<template>
	<div class="app-wrap"
		...
		<openbell :openbell-show.sync="openbell"></openbell>
		<orderbell :orderbell-show.sync="orderbell"></orderbell>
		<ordersuccess :ordersuccess-show.sync="ordersuccess"></ordersuccess>
		<orderfail :orderfail-show.sync="orderfail"></orderfail>
...
import openbell from './views/component/openBell.vue'
import orderbell from './views/component/orderBell.vue'
import ordersuccess from './views/component/orderSuccess.vue'
import orderfail from './views/component/orderFail.vue'
export default {
	props: {
		id: {
			type: String
	...
	methods: {
		...
		checkLogin() {
			...
			// }
			return document.cookie.indexOf('shortscreen_logined') >= 0;
		},
		addLoading(loading) {
			if (!loading.name) {
