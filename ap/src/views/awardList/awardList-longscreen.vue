...
export default {
    ...
    methods: {
        ...
        selectWinerPrize() {
            ...
            this.toExcel = 'acceptLog/getUserLoginLogToExcel?proNo=10007&status=null&reqTime=2016-12-09&aid=' + this.$route.params.aid + '&starttime=' + this.stime + '&endtime=' + this.etime;
            api.getUserLoginLog(this, {
