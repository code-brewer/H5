<template>
	<div class="qr-code-view-new">
		<div class="upload-view">
			<div class="left" :style="{'background-image':(qeCode.imgUrl!=''?'url('+qeCode.imgUrl+')':'url('+qeCode.defaultImgUrl+')')}">
...
<script>
	export default {
		...
		methods: {
			...
			setDefaultImg(){
				this.qeCode.imgUrl = this.qeCode.defaultImgUrl;
			}
		},
		events: {
			onFileChange(file) {
