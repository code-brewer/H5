<template>
	<div class="upload-image__wrapper upload"
		:class="{'md-center':isCenter}">
		<button class="btn-link btn btn-reset" @click="imgUrl = defaultImage">重置默认</button>
	</div>
</template>
<style>
...
export default {
	...
	ready() {
		...
		jQuery(this.$el).zyUpload(that.config);
	}
}
</script>
<style lang="scss">
