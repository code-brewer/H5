<template>
	<!-- 数据总览 -->
	<div class="component-data-overview row">
		<div class="component-data-overview-title col-md-2">
			活动累计
		</div>
		<div class="component-data-overview-box col-md-10">
			<div class="row">
				...
				<div class="component-data-overview-item col-md-2">
					<div class="icon"></div>
					<p class="data-qty">{{overviewData.join.qty}}</p>
					<dl>
						<dd>参与人数</dd>
					</dl>
				</div>
