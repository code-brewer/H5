<template>
    <div class="datepicker" ><!-- v-bind:style="{top: top, left: left}" -->
        <input class="form-control datepicker-input" type="text" v-bind:style="{width:width}" @click="inputClick" v-model="value" :placeholder="placeholder" style="padding-left:5px;box-sizing: border-box;" />
